# The Economist U.S. State Tile Grid Choropleth
...
# ggsave(
#   filename = "02_images/tile_grid_choropleth.png",
#   width = 3.4, 
#   height = 3.4,
#   units = "in",
#   dpi = 300
